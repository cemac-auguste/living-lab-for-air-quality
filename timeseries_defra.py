...
fig.update_layout(title_text='Time Series for data gathered near Defra Monitoring Site in the city centre of Leeds (19/08/2019) by Auguste Zagorskaite', xaxis_rangeslider_visible=True)
